...
<div class="row justify-content-center">
    <div class="col-md-8">
        <h1><i class="bi bi-tools"></i> Ajouter une nouvelle réparation</h1>
                ...
                <form action="{{ route('reparations.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('vehicule_id') is-invalid @enderror"
                            ...
                            <option value="{{ $vehicule->id }}" {{ old('vehicule_id') === (string)$vehicule->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('technicien_id') is-invalid @enderror"
                            ...
                            <option value="{{ $technicien->id }}" {{ old('technicien_id') === (string)$technicien->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('duree_main_oeuvre') is-invalid @enderror"
                                    id="duree_main_oeuvre" name="duree_main_oeuvre" value="{{ old('duree_main_oeuvre') }}" min="0">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('objet_reparation') is-invalid @enderror"
                            id="objet_reparation" name="objet_reparation" rows="5" required>{{ old('objet_reparation') }}</textarea>
