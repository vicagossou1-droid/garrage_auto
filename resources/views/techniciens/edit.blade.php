...
<div class="row justify-content-center">
    <div class="col-md-6">
        <h1><i class="bi bi-person-badge"></i> Modifier le technicien</h1>
                ...
                <form action="{{ route('techniciens.update', $technicien) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nom') is-invalid @enderror"
                            id="nom" name="nom" value="{{ old('nom', $technicien->nom) }}" required>
                        @error('nom')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('prenom') is-invalid @enderror"
                            id="prenom" name="prenom" value="{{ old('prenom', $technicien->prenom) }}" required>
                        @error('prenom')
                        <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('specialite') is-invalid @enderror"
                            id="specialite" name="specialite" value="{{ old('specialite', $technicien->specialite) }}"
