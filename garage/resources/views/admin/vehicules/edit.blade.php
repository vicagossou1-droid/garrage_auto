...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="fw-bold"><i class="bi bi-pencil"></i> Éditer Véhicule</h2>
        </div>
    </div>
            ...
            <form action="{{ route('admin.vehicules.update', $vehicule) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('client_id') is-invalid @enderror" id="client_id" name="client_id" required>
                        ...
                        <option value="{{ $client->id }}" @selected(old('client_id', $vehicule->client_id) == $client->id)>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('annee') is-invalid @enderror" id="annee" name="annee" value="{{ old('annee', $vehicule->annee) }}" required>
                        @error('annee')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('kilometrage') is-invalid @enderror" id="kilometrage" name="kilometrage" value="{{ old('kilometrage', $vehicule->kilometrage) }}">
                        @error('kilometrage')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('energie') is-invalid @enderror" id="energie" name="energie">
                        ...
                        <option value="electrique" @selected(old('energie', $vehicule->energie) == 'electrique')>Électrique</option>
                    </select>
                    @error('energie')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('admin.vehicules.show', $vehicule) }}" class="btn btn-secondary">
